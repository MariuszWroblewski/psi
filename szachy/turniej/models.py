...
class Uczestnik(models.Model):
    ...
    owner = models.ForeignKey('auth.User', related_name='uczestnik', on_delete=models.CASCADE, null=True)
...
class Turniej(models.Model):
    ...
    owner = models.ForeignKey('auth.User', related_name='turniej', on_delete=models.CASCADE, null=True)
...
class Rozgrywka(models.Model):
    ...
    owner = models.ForeignKey('auth.User', related_name='rozgrywka', on_delete=models.CASCADE, null=True)
